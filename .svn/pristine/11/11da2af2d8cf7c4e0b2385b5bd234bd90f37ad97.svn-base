...
<body onload="cambiar()">
						...
						<div class="panel-body">
							...
							<div class="row">
								...
								<div class="col-lg-12">
									...
									<div class="col-lg-1">
										<acme:checkbox id="check1" path="a8s"
											onchange="checkbox1(); cambiar();" />
									</div>
									<div class="col-lg-1">
										<acme:checkbox id="check2" path="a8n"
								...
								<div class="col-lg-12">
									...
									<div class="col-lg-12" align="center">
										<h3 id="errorSeleccion" hidden="true" style="color: #d9534f">
									...
									<div class="col-lg-2">
										<security:authorize
											...
											<a href="encuesta/cif2/paginaCinco.do"
												class="btn btn-default" role="button">Paso anterior</a>
										</security:authorize>
										<security:authorize access="hasAnyRole('ADMIN')">
											<a
												href="encuesta/cif2/verPaginaCinco.do?tipoCIF2Id=${tipoCIF2Id}"
												class="btn btn-default" role="button">Paso anterior</a>
										</security:authorize>
									</div>
									<div class="col-lg-2">
	...
	<script type="text/javascript">
		...
		function validate6() {
			...
			if(check2.checked==false && check1.checked==false){
				res=false;
				errorSeleccion.hidden=false;
			}
			else{
				errorSeleccion.hidden=true;
			}
			return res;
		}
