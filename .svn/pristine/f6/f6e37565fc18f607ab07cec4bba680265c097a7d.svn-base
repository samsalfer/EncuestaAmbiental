				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="alert alert-success">
							...
							ambientales <b>del total de los establecimientos/centros de la
								empresa que desarrollan una actividad ambiental en Andalucía.</b> En
							<b>empleo en protección ambiental</b> se contabiliza a
							...
							figuran en <a href="front/anexo4.pdf" target="_blank"><b>Anexo</b></a>)
							...
							ejemplo en <a href="front/anexo4.pdf" target="_blank"><b>Anexo</b></a>)
						</div>
						<div class="row">
						...
						<div class="col-lg-12" align="center">
							<h3 id="errorAmbientalDebeSerCero" hidden="true" style="color: #d9534f">
								Si no existen gastos corrientes de personal ocupado en actividades de protecci&oacute;n ambiental no puede existir empleo ambiental.</h3>
							...
							<h3 id="errorIgualdad" hidden="true" style="color: #d9534f">La
								facturación o los gastos ambientales son inferiores a los totales, por
								tanto las horas ambientales no pueden ser igual a las totales.</h3>
							...
							<h3 id="errorPg41" hidden="true" style="color: #d9534f">En
								...
								ambiental</h3>
							<h3 id="error18" hidden="true" style="color: #d9534f">
								Empleo total debe coincidir con empleo ambiental y n&uacute;mero de horas total con ambiental debido a que indic&oacute; que los campos facturaci&oacute;n, gasto total o gasto de personal coinciden en valor ambiental con total.</h3>
						</div>
						...
						<div class="col-lg-2">
							<security:authorize
								access="hasAnyRole('CIF4')">
								<a href="encuesta/cif4/paginaCuatro.do" class="btn btn-default"
									role="button">Paso anterior</a>
							</security:authorize>
							<security:authorize access="hasAnyRole('ADMIN')">
								<a
									href="encuesta/cif4/verPaginaCuatro.do?tipoCIF4Id=${tipoCIF4Id}"
...
<script type="text/javascript">
	...
	function validateTotalMayor() {
		...
		ambientalIgualAtotal = "${ambientalIgualAtotal}";		
		eaaNpoTotal = document.getElementById("eaaNpoTotal");
		eaaNhtTotal = document.getElementById("eaaNhtTotal");
		etNpoTotal = document.getElementById("etNpoTotal");
		etNhtTotal = document.getElementById("etNhtTotal");
		...
		if(( ambientalIgualAtotal == "true" && gastoPersonalCero == "false" && eaaNpoTotal.value!=etNpoTotal.value) || (ambientalIgualAtotal == "true" && gastoPersonalCero == "false" && eaaNhtTotal.value!=etNhtTotal.value)  ){
			res = false;
		...
		if(( ambientalIgualAtotal == "false"  && gastoPersonalCero == "false" && eaaNpoTotal.value==etNpoTotal.value && eaaNhtTotal.value==etNhtTotal.value)  ){
			res = false;
