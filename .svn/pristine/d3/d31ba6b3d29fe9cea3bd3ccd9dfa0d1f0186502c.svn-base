					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<div class="alert alert-success">
								Señale los motivos que, durante <b>2014</b>, han llevado a su
								empresa a la incorporación de eco-innovaciones o tecnologías
								ambientales <b>(máximo de tres)</b> y aquellos que suponen una
								limitación a su introducción <b>(máximo de tres)</b>.
							</div>
								...
								<div class="form-group">
									<p>
										<b>8.1. Factores principales que motivan introducir
											eco-innovaciones o tecnologías ambientales:</b> (señalar 3
										máximo)
									</p>
								</div>
							</div>
							...
							<div class="col-lg-12">
								...
								<div class="col-lg-4">
									<div class="form-group">
										<p>Adaptación a la legislación ambiental</p>
									</div>
								</div>
								<div class="col-lg-1">
								...
								<div class="col-lg-4">
									<div class="form-group">
										<p>Impedir sanciones de la Administración</p>
									</div>
								</div>
								<div class="col-lg-1">
							...
							<div class="col-lg-12">
								...
								<div class="col-lg-4">
									<div class="form-group">
										<p>Obtención de ayudas, subvenciones e incentivos fiscales</p>
									</div>
								</div>
								<div class="col-lg-1">
							...
							<div class="col-lg-12">
								...
								<div class="col-lg-4">
									<div class="form-group">
										<p>Presión de determinados grupos (ecologistas,
											sindicatos, ONGs...)</p>
									</div>
								</div>
								<div class="col-lg-1">
							...
							<div class="col-lg-12">
								...
								<div class="col-lg-4">
									<div class="form-group">
										<p>Elevado coste de inversión</p>
									</div>
								</div>
								<div class="col-lg-1">
							...
							<div class="col-lg-12">
								...
								<div class="col-lg-4">
									<div class="form-group">
										<p>Falta de información y formación de la dirección</p>
									</div>
								</div>
								<div class="col-lg-1">
							...
							<div class="col-lg-12">
								...
								<div class="col-lg-4">
									<div class="form-group">
										<p>Falta de valoración por parte del cliente/ consumidor</p>
									</div>
								</div>
								<div class="col-lg-1">
							...
							<div class="col-lg-12">
								<div class="form-group">
									<p>
										<b>8.3. ¿Cuenta con sistema de gestión medioambiental
											implantado?</b>
									</p>
								</div>
							</div>
						...
						<h3 id="errorFactor" hidden="true" style="color: #d9534f">
									Si se ha realizado inversión en protección ambiental durante el año 2014, debe existir algún factor que motive la introducción de eco-innovaciones o tecnologías ambientales.</h3>
						...
						<h3 id="errorGestion" hidden="true" style="color: #d9534f">
									Seleccione una certificación.</h3>
