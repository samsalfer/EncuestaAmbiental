				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="alert alert-success" align="justify">
							...
							adscrito a la entidad pública; se excluye, por tanto, el personal
							ocupado en cualquier otro organismo vinculado, empresa pública o
							...
							actividades. El <b>número de personas ocupadas</b> corresponde al
							total de personas dedicadas íntegra o parcialmente a actividades
							ambientales en el <b>año 2014</b> y el <b>número de horas
								trabajadas</b> se refiere asimismo al total anual. (Véase ejemplo en
						...
						<div class="row">
							...
							<div class="col-lg-12">
								...
								<div class="col-lg-4">
									<p>
										<b>Gestión ambiental del medio atmosférico:</b>
									</p>
								</div>
								<div class="col-lg-7">&nbsp;</div>
							</div>
							...
							<div class="col-lg-12">
								<div class="col-lg-1">&nbsp;</div>
								<div class="col-lg-3">
									<p>Control y reducción de la contaminación del aire</p>
								</div>
								<div class="col-lg-1">
									<div class="form-group input-group">
							...
							<div class="col-lg-12">
								<div class="col-lg-1">&nbsp;</div>
								<div class="col-lg-3">
									<p>Control de la contaminación por ruidos y vibraciones</p>
								</div>
								<div class="col-lg-1">
									<div class="form-group input-group">
							...
							<div class="col-lg-12">
								...
								<div class="col-lg-4">
									<p>
										<b>Gestión sostenible de los recursos hídricos y
											descontaminación de espacios:</b>
									</p>
								</div>
								<div class="col-lg-7">&nbsp;</div>
							</div>
							...
							<div class="col-lg-12">
								<div class="col-lg-1">&nbsp;</div>
								<div class="col-lg-3">
									<p>Saneamiento y restauración de suelos, cursos y masas de agua contaminados</p>
								</div>
								<div class="col-lg-1">
									<div class="form-group input-group">
							...
							<div class="col-lg-12">
								...
								<div class="col-lg-4">
									<p>
										<b>Gestión de residuos y reciclaje:</b>
									</p>
								</div>
								<div class="col-lg-7">&nbsp;</div>
							</div>
							...
							<div class="col-lg-12">
								<div class="col-lg-1">&nbsp;</div>
								<div class="col-lg-3">
									<p>Recogida, transporte, almacenamiento y eliminación de residuos</p>
								</div>
								<div class="col-lg-1">
									<div class="form-group input-group">
							...
							<div class="col-lg-12">
								<div class="col-lg-1">&nbsp;</div>
								<div class="col-lg-3">
									<p>Reciclaje y valorización de residuos</p>
								</div>
								<div class="col-lg-1">
									<div class="form-group input-group">
							...
							<div class="col-lg-12">
								...
								<div class="col-lg-3">
									<p>
										<b>Gestión sostenible de la anergía: Energía Renovable</b>
									</p>
								</div>
								<div class="col-lg-1">
									<div class="form-group input-group">
							...
							<div class="col-lg-12">
								...
								<div class="col-lg-3">
									<p>
										<b>Agricultura y ganadería ecológicas</b>
									</p>
								</div>
								<div class="col-lg-1">
									<div class="form-group input-group">
							...
							<div class="col-lg-12">
								...
								<div class="col-lg-3">
									<p>
										<b>Gestión de espacios protegidos y actividades forestales sostenibles</b>
									</p>
								</div>
								<div class="col-lg-1">
									<div class="form-group input-group">
							...
							<div class="col-lg-12">
								...
								<div class="col-lg-3">
									<p>
										<b>Educación y sensibilización ambiental</b>
									</p>
								</div>
								<div class="col-lg-1">
									<div class="form-group input-group">
							...
							<div class="col-lg-12">
								...
								<div class="col-lg-3">
									<p>
										<b>Ecoinnovación, investigación y desarrollo en materia
											ambiental</b>
									</p>
								</div>
								<div class="col-lg-1">
							...
							<div class="col-lg-12">
								...
								<div class="col-lg-3">
									<p>
										<b>Consultoría e ingeniería ambiental multi-ámbito</b>
									</p>
								</div>
								<div class="col-lg-1">
									<div class="form-group input-group">
							...
							<div class="col-lg-12">
								...
								<div class="col-lg-3">
									<p>
										<b>Construcción sostenible : Edificación, rehabilitación y
							...
							<div class="col-lg-12" align="center">
								<h3 id="errorHombreOcupados" hidden="true" style="color: #d9534f">
									Sumatorio Hombres ocupados en la i-ésima actuación ambiental debe ser mayor o igual a hombres ocupados en actividades ambientales.</h3>
								<h3 id="errorMujerOcupados" hidden="true" style="color: #d9534f">
									Sumatorio Mujeres ocupados en la i-ésima actuación ambiental debe ser mayor o igual a mujeres ocupados en actividades ambientales.</h3>
								<h3 id="errorTotalOcupados" hidden="true" style="color: #d9534f">
									Sumatorio Total ocupados en la i-ésima actuación ambiental debe ser mayor o igual a total ocupados en actividades ambientales.</h3>
								<h3 id="errorHombresHoras" hidden="true" style="color: #d9534f">
									Sumatorio Horas trabajadas por hombres en la i-ésima actuación ambiental debe ser igual a total de horas trabajadas por hombres en actividades ambientales.</h3>
								<h3 id="errorMujerHoras" hidden="true" style="color: #d9534f">
									Sumatorio Horas trabajadas por mujeres en la i-ésima actuación ambiental debe ser igual a total de horas trabajadas por mujeres en actividades ambientales.</h3>
								<h3 id="errorTotalHoras" hidden="true" style="color: #d9534f">
									Sumatorio Total de horas trabajadas en la i-ésima actuación ambiental debe ser igual a total de horas en actividades ambientales.</h3>
								
								<h3 id="errorCol1" hidden="true" style="color: #d9534f">
									Total de hombres ocupados debe ser mayor o igual a la suma de total de hombres ocupados en la i-ésima actuación ambiental.</h3>
								<h3 id="errorCol2" hidden="true" style="color: #d9534f">
									Total de mujeres ocupados debe ser mayor o igual a la suma de total de mujeres ocupados en la i-ésima actuación ambiental.</h3>
								<h3 id="errorCol3" hidden="true" style="color: #d9534f">
									Empleo Total debe ser mayor o igual a la suma de total ocupados en la i-ésima actuación ambiental.</h3>
								
								<h3 id="errorCol4" hidden="true" style="color: #d9534f">
									Total de horas trabajadas por hombres debe ser mayor o igual a la suma total de horas trabajadas por hombres en la i-ésima actuación ambiental.</h3>
									
								<h3 id="errorCol5" hidden="true" style="color: #d9534f">
									Total de horas trabajadas por mujeres debe ser mayor o igual a la suma total de horas trabajadas por mujeres en la i-ésima actuación ambiental.</h3>
								<h3 id="errorCol6" hidden="true" style="color: #d9534f">
									Total de horas trabajadas debe ser mayor o igual a la suma total de horas trabajadas en la i-ésima actuación ambiental.</h3>
...
function concordancia1() {
	...
	//Comprobación el empleo total es mayor que la desagregación.
		...
		//recorro el array de gastopersonal junto con cada elemento para ponerlo a obligatorio si está en el array-
	var reg11 = /a32..3/;
	var j=0;	
	var total = 0;
	var frm = document.getElementById("commentForm");
