...
<jstl:if test="${tipoCIF1!=null}">
	<jstl:import url="../../pages/cif1/paginaSiete.jsp" />
</jstl:if>

<jstl:if test="${tipoCIF2!=null}">
	<jstl:import url="../../pages/cif2/paginaSiete.jsp" />
</jstl:if>

<jstl:if test="${tipoCIF3!=null}">
	<jstl:import url="../../pages/cif3/paginaSiete.jsp" />
</jstl:if>

<jstl:if test="${tipoCIF4!=null}">
	<jstl:import url="../../pages/cif4/paginaSiete.jsp" />
</jstl:if>