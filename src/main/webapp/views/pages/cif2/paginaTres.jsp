					...
					<div class="panel-body">
						<div class="alert alert-success">
							...
							actividades ambientales, según se definen en <a
								href="front/anexo2.pdf" target="_blank"><b>Anexo</b></a>, <b>para
						...
						<div class="row">
							...
							<div class="col-lg-12">
								...
								<div class="col-lg-2">
									<div class="form-group input-group">
										<form:input id="inversionesRealesGlobal" required="true" path="a414"
											class="form-control" />
										<span class="input-group-addon">&#8364;</span>
									</div>
								</div>
							...
							<h3 id="errorSumasA" hidden="true" style="color: #d9534f">
							El gasto total ambiental debe ser mayor o igual que la suma de gasto de personal e inversiones reales.</h3>
							<h3 id="errorSumasG" hidden="true" style="color: #d9534f">
							El gasto total global debe ser mayor o igual que la suma de gasto de personal e inversiones reales.</h3>
								...
								<div class="col-lg-8">
									...
									<div class="alert alert-success">
										...
										Véase clasificación y definiciones en <a
											href="front/anexo2.pdf" target="_blank"><b>Anexo</b></a>. No
...
<script>
	...
	function controlSumas(){
		...
		if(parseFloat(totalGlobal.value) < (parseFloat(personalGlobal.value)+parseFloat(realesGlobal.value))){
			...
			res = false;
			errorSumasG.hidden = false;
			totalGlobal.focus();
		}
		else{
			errorSumasG.hidden = true;
		...
		if(parseFloat(totalAmbiental.value) < (parseFloat(personalAmbiental.value)+parseFloat(realesAmbiental.value))){
			...
			res = false;
			errorSumasA.hidden = false;
			totalAmbiental.focus();
		}
		else{
			errorSumasA.hidden = true;
