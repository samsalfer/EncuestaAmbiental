	...
	<form:form action="${requestURI}" modelAttribute="formularioCuatroForm"
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="alert alert-success">
							Señale con un aspa [X] las <b>modalidades formativas en
								materia ambiental</b> que fueron ofertadas por los
							establecimientos/centros durante 2014. Véase clasificación y
							definición en <a href="front/anexo2.pdf" target="_blank"><b>Anexo</b></a>.
						</div>
						...
						<div class="col-lg-12">
							...
							<div class="col-lg-12">
								...
								<div class="col-lg-5">
									<p>Formación para el empleo (Formación Profesional
										Ocupacional y Formación Continua)</p>
								</div>
							...
							<div class="col-lg-12">
								<div class="col-lg-1">&nbsp;</div>
								<div class="col-lg-5">
									<p>Formación especializada no reglada</p>
								</div>
							...
							<div class="col-lg-12">
								<div class="col-lg-1">&nbsp;</div>
								<div class="col-lg-5">
									<p>Programas de Educación Ambiental (Centros de Educación
										Ambiental)</p>
								</div>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">
						<b> A6. Áreas  de educación y sensibilización, investigación y desarrollo ambientales.</b>
					</div>
					<div class="panel-body">
						<div class="alert alert-success">
							Consigne en este apartado las áreas preferentes <b>(con un
								máximo de tres)</b>, en relación a las actividades de Educación y
							Sensibilización, y de Ecoinnovación, investigación y desarrollo
							en materia ambiental desarrolladas en los
							establecimienotos/centros. Véase definiciones en <a
						...
						<div class="col-lg-12">
							...
							<div class="col-lg-2">
								<div class="form-group">
									<p align="center">
										<b>Educación y Sensibilización</b>
									</p>
								</div>
							</div>
							<div class="col-lg-2">
							...
							<div class="col-lg-12">
								<div class="col-lg-1">&nbsp;</div>
								<div class="col-lg-5">
									<label>Gestión ambiental del medio atmosférico:</label>
								</div>
							</div>
							<!-- Tab12 -->
							<div class="col-lg-12">
							...
							<div class="col-lg-12">
								<div class="col-lg-1">&nbsp;</div>
								<div class="col-lg-5">
									<p>Control y reducción de la contaminación por ruidos y
										vibraciones</p>
								</div>
							...
							<div class="col-lg-12">
								<div class="col-lg-1">&nbsp;</div>
								<div class="col-lg-5">
									<label>Gestión sostenible de recursos hídricos y
										descontaminación de espacios:</label>
								</div>
							</div>
							...
							<div class="col-lg-12">
								<div class="col-lg-1">&nbsp;</div>
								<div class="col-lg-5">
									<p>Saneamiento y restauración de suelos, cursos y masas de
										agua contaminados</p>
								</div>
							...
							<div class="col-lg-12">
								<div class="col-lg-1">&nbsp;</div>
								<div class="col-lg-5">
									<label>Gestión de residuos y reciclaje:</label>
								</div>
							</div>
							...
							<div class="col-lg-12">
								<div class="col-lg-1">&nbsp;</div>
								<div class="col-lg-5">
									<p>Recogida, transporte, almacenamiento y eliminación de
										residuos</p>
								</div>
							...
							<div class="col-lg-12">
								<div class="col-lg-1">&nbsp;</div>
								<div class="col-lg-5">
									<label>Gestión sostenible de la energía: Energía
										renovable</label>
								</div>
							...
							<div class="col-lg-12">
								<div class="col-lg-1">&nbsp;</div>
								<div class="col-lg-5">
									<label>Agricultura y ganadería ecológicas</label>
								</div>
							...
							<div class="col-lg-12">
								<div class="col-lg-1">&nbsp;</div>
								<div class="col-lg-5">
									<label>Gestión de espacios protegidos y actividades
							...
							<div class="col-lg-12">
								<div class="col-lg-1">&nbsp;</div>
								<div class="col-lg-5">
									<label>Construcción sostenible: Edificación,
										rehabilitación y eficiencia energética</label>
								</div>
							...
							<div class="col-lg-12">
								<div class="col-lg-1">&nbsp;</div>
								<div class="col-lg-5">
									<label>Otros ámbitos (especificar):</label>
								</div>
							...
							<div class="col-lg-12" align="center">
								<h3 id="errorModalidad3" hidden="true" style="color: #d9534f">
									Debe existir algún área de educación y sensibilización ambiental.</h3>
								<h3 id="errorModalidad4" hidden="true" style="color: #d9534f">
								Debe existir algún área de I+D+i ambiental.</h3>
