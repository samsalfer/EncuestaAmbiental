									...
									<div class="form-group">
										<div class="checkbox">
											<label> <acme:checkbox id="check4" path="a313"
													onchange="checkbox4()" />Entidad sin ánimo de lucro de
												carácter privado (asociación, fundación, etc.)
											</label>
										</div>
									</div>
								</div>
									...
									<div class="form-group">
										<div class="checkbox">
											<label> <acme:checkbox id="check5" path="a315"
												...
												fundación con participación pública
											</label>
							...
							<div class="alert alert-success">
								...
								<p align="justify">
									...
									est&aacute dirigido a <b>los establecimientos y centros
										especializados en los ámbitos de la Educación y
										sensibilización ambiental, y en la Ecoinnovación,
										investigación y desarrollo en materia ambiental.</b>
								</p>
								<br>
