						...
						<div class="panel-body">
							...
							<div class="row" style="margin-top: -25px;">
								...
								<div class="col-lg-12">
									<div class="form-group">
										<div class="checkbox">
											<label> <acme:checkbox id="check1" path="a211"
								...
								<div class="col-lg-12">
									<div class="form-group">
										<div class="checkbox">
											<label> <acme:checkbox id="check2" path="a212"
								...
								<div class="col-lg-12">
									<div class="form-group">
										<div class="checkbox">
											<label> <acme:checkbox id="check3" path="a213"
								...
								<div class="col-lg-7">
									<div class="form-group">
										<form:input id="publica1" path="a2131" class="form-control"
											disabled="true" required="true" />
									</div>
								</div>
								<div class="col-lg-2">
									<div class="form-group input-group">
										<form:input id="publica11" path="a2131P" class="form-control"
								...
								<div class="col-lg-7">
									<div class="form-group">
										<form:input id="publica2" path="a2132" class="form-control"
											disabled="true" />
									</div>
								</div>
								<div class="col-lg-2">
									<div class="form-group input-group">
										<form:input id="publica21" path="a2132P" class="form-control"
								...
								<div class="col-lg-7">
									<div class="form-group">
										<form:input id="publica3" path="a2133" class="form-control"
											disabled="true" />
									</div>
								</div>
								<div class="col-lg-2">
									<div class="form-group input-group">
										<form:input id="publica31" path="a2133P" class="form-control"
											min="0" max="100" disabled="true" />
										<span class="input-group-addon">%</span>
									</div>
								</div>
								...
								<div class="col-lg-5">
									<h3 id="errorCien" hidden="true" style="color: #d9534f">El
										porcentaje total participación debe ser 100%</h3>
									&nbsp;
								</div>
								<div class="col-lg-2">
							...
							<div class="alert alert-success">
								...
								<p align="justify">
									...
									está dirigido a los establecimientos industriales localizados
									en Andalucía, al objeto de recabar información sobre gastos y
									empleo en actuaciones de protección ambiental.
								</p>
								<br>
								...
								<p align="justify">
									...
									identificación de la portada corresponden a la razón social de
									la empresa, <b>la información económica y de empleo que se
										solicita en este cuestionario debe corresponder exclusivamente
										a los establecimientos de la empresa que desarrollan una
										actividad económica en Andalucía.</b>
								</p>
								<p align="justify">
								...
								<p align="justify">
									...
									relativos a los distintos apartados del cuestionario en el <b><a
										href="front/anexo4.pdf" target="_blank"><b>Anexo</b></a> al
										mismo.</b>
								</p>
								<p align="justify">
