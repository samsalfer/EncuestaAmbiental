			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">
						<b>A2. Información sobre Gasto Liquidado</b>
					</div>
					<div class="panel-body">
						<div class="alert alert-success" align="justify">
							...
							Gasto en inversiones reales correspondientes al total del <b>Presupuesto
								Liquidado de 2014</b>, así como para cada uno de las <b>actividades
								ambientales</b>, según la descripción y correspondencia aproximada
							con la Clasificación por Programas del Presupuesto de Gastos que
							figura en <a href="front/anexo3.pdf" target="_blank">Anexo</a>. El Gasto total corresponde a la <b>suma de
								los capítulos 1 a 9</b> de la Clasificación Económica del
							Presupuesto de Gastos; el Gasto de personal al <b>capítulo 1</b>
							y las Inversiones reales al <b>capítulo 6</b> de dicha
							clasificación.
						</div>
			...
			<div class="col-lg-12">
				...
				<div class="col-lg-8">&nbsp;</div>
							...
							<h3 id="errorTotal" hidden="true" style="color: #d9534f">
								Debe existir al menos gasto total en un ámbito de actuación ambiental.</h3>
							<h3 id="errorPersonal" hidden="true" style="color: #d9534f">
								Debe existir al menos gasto de personal en un ámbito de actuación ambiental.</h3>
							<h3 id="errorInversion" hidden="true" style="color: #d9534f">
								Debe existir al menos inversión real en un ámbito de actuación ambiental.</h3>
