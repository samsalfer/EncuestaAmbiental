		...
		<form:form action="${requestURI}" modelAttribute="formularioUnoForm"
			...
			<div class="row">
				<div class="col-lg-12 col-md-12">
					<h1 class="page-header">Encuesta sobre Actividad
						Econ&oacutemica y Medio Ambiente en Andaluc&iacutea 2014 (1/4)</h1>
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<div class="alert alert-success">El campo Código Municipal
								está deshabilitado para que sea cumplimentado automáticamente.</div>
							<div class="row">
								<!-- Tab12 -->
								<div class="col-lg-6">
								...
								<div class="col-lg-2">
									<div class="form-group">
										...
										<form:input id="cp" path="a106" class="form-control"
											rangelength="5,5" />
									</div>
								</div>
								...
								<div class="col-lg-4">
									<div class="form-group">
										...
										<form:select path="a107" id="provincia"
											...
											<form:option value='A Coruña'>A Coruña</form:option>
											<form:option value='álava'>Álava</form:option>
											<form:option value='Albacete'>Albacete</form:option>
											<form:option value='Alicante'>Alicante</form:option>
											<form:option value='Almería'>Almería</form:option>
											<form:option value='Asturias'>Asturias</form:option>
											<form:option value='ávila'>Ávila</form:option>
											...
											<form:option value='Cáceres'>Cáceres</form:option>
											<form:option value='Cádiz'>Cádiz</form:option>
											<form:option value='Cantabria'>Cantabria</form:option>
											<form:option value='Castellón'>Castellón</form:option>
											<form:option value='Ceuta'>Ceuta</form:option>
											<form:option value='Ciudad Real'>Ciudad Real</form:option>
											<form:option value='Córdoba'>Córdoba</form:option>
											...
											<form:option value='Malaga'>Málaga</form:option>
			...
			<div class="alert alert-success">
				...
				<p align="justify">
					...
					Andaluc&iacutea 2013-2017. La finalidad de la encuesta es obtener
					informaci&oacuten sobre actividad econ&oacutemica y empleo
					ambientales en Andaluc&iacutea. El presente cuestionario está
					dirigido a las entidades de la Administración Local andaluza, al
					objeto de recabar información sobre gasto público y empleo en
					actuaciones ambientales.</b>
				</p>
				<br>
				...
				<p align="justify">
					Ser&aacuten objeto de protecci&oacuten y quedar&aacuten amparados
					por el <b>secreto estad&iacutestico</b> todos los datos de
					&iacutendole privada que se utilicen en la actividad
					estad&iacutestica (art. 9.2 de la Ley 4/1989, de 12 de diciembre,
					de Estad&iacutestica de la Comunidad Aut&oacutenoma de
					Andaluc&iacutea). Todo el personal u &oacutergano de la
					Administraci&oacuten andaluza, as&iacute como los agentes
					colaboradores ajenos a la misma, que intervengan en la actividad
					estad&iacutestica, tendr&aacuten la obligaci&oacuten de mantener el
					secreto estad&iacutestico (arts. 11 y 13 de la Ley 4/1989).
				</p>
				<br>
				<h4>
				...
				<p align="justify">Ser&aacute obligatorio suministrar la
					...
					jur&iacutedicas que tengan su domicilio, residencia o actividad en
					el territorio de Andaluc&iacutea. La obligaci&oacuten se extiende
					tambi&eacuten a todas las administraciones y entidades
					p&uacuteblicas en lo que se refiere a las actividades llevadas a
					cabo dentro del territorio de la comunidad aut&oacutenoma de
					Andaluc&iacutea (arts. 14.1 y 14.2 de la Ley 4/1989).</p>
				<p align="justify">
					<b>El incumplimiento</b> de las obligaciones establecidas en la
					referida Ley constituye infracci&oacuten administrativa en materia
					de estad&iacutestica en la Comunidad Aut&oacutenoma de
					Andaluc&iacutea, y <b>ser&aacute sancionado</b> de acuerdo con lo
					dispuesto en la norma. Las infracciones muy graves ser&aacuten
					sancionadas con multas de <b>3.005,07 a 30.050,61 &#8364;</b>; las
					infracciones graves se sancionar&aacuten con multas de <b>300,52
						a 3.005,06 &#8364;</b>; las infracciones leves se sancionar&aacuten
					con multas de hasta <b>300,51 &#8364</b> (arts. 43 y 46 de la Ley
					4/1989).
				</p>
				<br>
				<h4>
				...
				<p align="justify">
					<b>Unidad de informaci&oacuten:</b> La información que se solicita
					en este cuestionario se refiere a la <b>entidad pública</b> cuyos
					datos de identificación figuran en portada, <b>excluyendo</b> a sus
					organismos autónomos o empresas públicas vinculadas.
				</p>
				<p align="justify">
					<b>Per&iacuteodo de referencia:</b> Los datos deben referirse al
					a&ntildeo <b>2014</b>. Los datos sobre gastos se refieren al <b>Presupuesto
						Liquidado de 2014</b>; en caso de no disponerse de dicha información,
					los datos se referirán al Presupuesto inicial para dicha anualidad,
					indicándose esta incidencia en el apartado <b>Observaciones</b>.
				</p>
				<p align="justify">
					<b>Forma de anotar los datos:</b> Cumplimente los datos claramente.
					Los datos econ&oacutemicos se anotar&aacuten en <b>euros</b>; en caso de
					anotar los datos en miles de euros, se indicar&aacute en el
						apartado <b>Observaciones.</b>
				</p>
				<p align="justify">
					<b>Notas aclaratorias:</b> Se incluye definiciones y ejemplos relativos a los distintos apartados del cuestionario en el <b>Anexo</b> al mismo.
				</p>
				<p align="justify">
					<b>Plazo de remisión:</b> Este cuestionario cumplimentado con la información solicitada debe ser devuelto en un plazo no superior a <b>20 días</b>.
				</p>
			</div>
		</form:form>
	</div>
