...
<jstl:if test="${tipoCIF1!=null}">
	<jstl:import url="../../pages/cif1/paginaTres.jsp" />
</jstl:if>

<jstl:if test="${tipoCIF2!=null}">
	<jstl:import url="../../pages/cif2/paginaTres.jsp" />
</jstl:if>

<jstl:if test="${tipoCIF3!=null}">
	<jstl:import url="../../pages/cif3/paginaTres.jsp" />
</jstl:if>

<jstl:if test="${tipoCIF4!=null}">
	<jstl:import url="../../pages/cif4/paginaTres.jsp" />
</jstl:if>