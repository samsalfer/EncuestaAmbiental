			...
			<div class="panel panel-green">
				...
				<div class="panel-body">
					<p align="justify">Sus datos han sido enviados
						satisfactoriamente, gracias por su colaboración.</p>
					<p align="justify">Una vez que la encuesta ha sido enviada sin
						ningún tipo de error y algún revisor haya validado la encuesta,
						ésta pasará a estar totalmente cumplimentada y terminada por lo
						que no es necesario que el usuario que rellena la encuesta realize
						más acciones. En el caso que la encuesta no quede validada, el
						usuario podrá volver a entrar en el sistema con los mismos
...
<security:authorize access="hasAnyRole('ADMIN')">
	...
	<div class="row" align="center">
		...
		<div class="col-lg-2 col-lg-offset-2">
			...
			<div class="panel-body">
				<p align="justify">La encuesta ha sido completada sin ningún
					tipo de error y cumpliendo todas las reglas de validación. Queda
					pendiente la validación de esta por parte de un revisor.</p>
			</div>
	...
	<div class="col-lg-2">
		...
		<div class="panel-heading">Encuesta válida</div>
		<div class="panel-body">
			<p align="justify">Un revisor ha revisado esta encuesta y ha
				determinado que es totalmente válida.</p>
		</div>
		<div class="panel-footer">
			<jstl:choose>
				<jstl:when test="${tipoCIF1.validado == true}">
